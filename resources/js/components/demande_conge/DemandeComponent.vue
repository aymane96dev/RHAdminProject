<template>
    <div class="row justify-content-center mb-5">
        ...
        <div class="col-xl-8 mb-5 mb-xl-0 text-white">
            <demande-list-component :idprop="id" :conges="conges" :demandes="demandes" v-on:editEvent="editEventHandler($event)" v-on:deleteEvent="deleteEventHandler($event)" v-on:addEvent="addEventHandler($event)"></demande-list-component>
        </div>
    </div>
</template>
