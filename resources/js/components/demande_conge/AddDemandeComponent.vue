    ...
    <div class="modal fade" id="addDemandeModal" tabindex="-1" role="dialog" aria-labelledby="addDemandeModalLabel" aria-hidden="true" >
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title text-lg" id="exampleModalLabel">Ajouter un demande de congé {{ idprop }} :</h5>
...
export default {
    ...
    data(){
        return {
            ...
            demande:{
                ...
                lettre_ecrit:'',
                commentaire:'',
                etat_validation:'En attente de validation'
            },
            filename:'',
            error:false,
            conge:{}
    ...
    methods: {
        ...
        addDemande(){
            ...
            axios.post('api/addDemande',formdata,
            {
                headers: {
            ...
            .then(data => {
                ...
                this.demande.date_debut = '';
                this.demande.date_fin = '';
                this.demande.lettre_ecrit = '';
                this.demande.commentaire = '';
                this.demande.conge_id = '';
                $('#addDemandeModal').modal('toggle');
                this.error=false;
            })
