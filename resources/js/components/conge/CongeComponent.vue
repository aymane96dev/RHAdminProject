<template>
  <div class="row justify-content-center mb-5">
        ...
        <div class="col-xl-8 mb-5 mb-xl-0 text-white">
            <conge-list-component :idprop="id" :conges="conges" v-on:addcongevent="UpdateAfter($event)" v-on:editcongevent="UpdateAfter($event)" v-on:deleteevent="UpdateAfter($event)"></conge-list-component>
        </div>
    </div>
</template>
