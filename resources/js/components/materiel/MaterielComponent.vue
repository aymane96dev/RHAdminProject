<template>
    <div class="row justify-content-center mb-5">
        ...
        <div class="col-xl-8 mb-5 mb-xl-0 text-white">
            <materiel-list-component :idprop="id" :materiels="materiels" v-on:AddMatEvent="eventHandler($event)" v-on:EditMatEvent="eventHandler($event)" v-on:DelMatEvent="eventHandler($event)"  ></materiel-list-component>
        </div>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        getMateriels(){
            axios.get(`api/materiels/${this.id}`)
