<template>
  <div class="modal fade" id="addMaterielModal" tabindex="-1" role="dialog" aria-labelledby="addMatModalLabel" aria-hidden="true" >
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-lg" id="exampleModalLabel">Ajouter un matériel :</h5>
    ...
    methods:{
        addMateriel(){
            ...
            .then(data =>{
                ...
                this.$emit('AddMatEvent',vals);
                this.materiel.libelle='';
                this.materiel.matricule='';
                this.materiel.date_achat='';
                this.materiel.serie='';
                this.materiel.type='';
            })
            .catch(err => console.log(err))
            $("#addMaterielModal").modal('toggle');
        }
    }
}
</script>
