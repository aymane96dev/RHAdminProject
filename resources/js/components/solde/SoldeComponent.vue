<template>
    <div class="row justify-content-center mb-5">
        ...
        <div class="col-xl-8 mb-5 mb-xl-0 text-white">
            <solde-list-component :idprop="id" :soldes="soldes" v-on:addEvent="EventHandler($event)" v-on:editEvent="EventHandler($event)" v-on:deleteEvent="EventHandler($event)"></solde-list-component>
        </div>
    </div>
</template>
