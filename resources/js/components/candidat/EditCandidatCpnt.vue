<template>
    <div class="modal fade" id="editCandidatModal" tabindex="-1" role="dialog" aria-labelledby="editCandidatModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-dark">
                    <form @submit.prevent="editCandidat">
                        ...
                        <div class="form-group row ml-3">
                            ...
                            <div class="custom-file col-sm-6 ml-3">
                                ...
                                <label class="custom-file-label col-form-label-sm" for="photo" >{{filename || candidat.cv}}</label> 
                            </div> 
                        </div>
                        <div class="form-group row ml-3">
...
export default {
    ...
    methods: {
        ...
        editCandidat(){
            ...
            axios.post('api/editCandidat',formdata,
            {
                headers: {
            ...
            .then(data => {
                ...
                $('#editCandidatModal').modal('toggle');
            })
